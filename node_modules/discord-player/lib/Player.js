...
class Player extends events_1.EventEmitter {
                ...
                case 'spotify_song':
                    {
                        ...
                        if (matchSpotifyURL) {
                            const spotifyData = yield spotify_url_info_1.default.getPreview(query).catch(() => { });
                            if (spotifyData) {
    ...
    lyrics(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield extractor.Lyrics(query);
    ...
    _playStream(queue, updateFilter, seek) {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (queue.playing.raw.source === 'youtube') {
                newStream = discord_ytdl_core_1.default(queue.playing.url, Object.assign({ opusEncoded: true, encoderArgs: queue.playing.raw.live ? [] : encoderArgs, seek: seekTime / 1000, 
            ...
            setTimeout(() => {
                ...
                queue.voiceConnection.play(newStream, {
                    type: 'opus',
                    bitrate: 'auto',
                    volume: Util_1.default.isRepl() ? false : undefined
                });
                if (seekTime) {
